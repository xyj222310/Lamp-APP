...
import com.cxs.androidlib.utils.PrefUtils;
...
public class SettingCenter {
    ...
    public static boolean getOnlyWifiLoadImage() {
        return PrefUtils.getBoolean(CommonApplication.getInstance(), "getOnlyWifiLoadImage", false);
    }

    public static void setOnlyWifiLoadImage(boolean isEnable) {
        PrefUtils.putBoolean(CommonApplication.getInstance(), "getOnlyWifiLoadImage", isEnable);
    }
    ...
    public static void countDirSizeTask(final CountDirSizeListener listener) {
        new Thread() {
            public void run() {
                final long result = getDirSize(CommonApplication.getInstance().getCacheDir());
    ...
    public static void clearAppCache(final ClearCacheListener listener) {
        new Thread() {
            public void run() {
                clearFile(CommonApplication.getInstance().getCacheDir());
                Handler handler = new Handler(Looper.getMainLooper());
                handler.post(new Runnable() {
                    @Override
                    public void run() {

...
package com.cxs.androidlib.activity;
...
import com.cxs.androidlib.activity.base.BaseActivity;
import com.cxs.androidlib.imageloader.ImageLoader;
import com.cxs.androidlib.rx.retrofit.ObservableProvider;
import com.cxs.androidlib.rx.retrofit.subscriber.DownLoadSubscribe;
import com.cxs.androidlib.utils.FileUtils;
import com.cxs.androidlib.utils.SLog;
import com.cxs.androidlib.utils.SnackBarUtils;
import com.cxs.androidlib.utils.SystemShareUtils;
        ...
        ObservableProvider.getDefault().download(mUrlList.get(0), new DownLoadSubscribe(FileUtils.getSaveImagePath(this), FileUtils.getFileName(mUrlList.get(0))) {
            ...
            public void onCompleted(File file) {
                if (action == 0) {
                    ...
                    MediaScannerConnection.scanFile(CommonApplication.getInstance(), new String[]{
                                    mSavePath},
                            null, null);
                } else {

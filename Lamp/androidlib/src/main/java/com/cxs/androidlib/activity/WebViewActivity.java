...
import com.cxs.androidlib.fragment.WebViewFragment;
import com.cxs.androidlib.utils.ClipboardUtils;
...
public class WebViewActivity extends BaseActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_copy) {
            ClipboardUtils.setText(CommonApplication.getInstance(), mUrl);
    ...
    protected void setUpData() {
        ...
        mFragmentManager.beginTransaction().replace(R.id.fl_content_web, mWebViewFragment).commit();
    }

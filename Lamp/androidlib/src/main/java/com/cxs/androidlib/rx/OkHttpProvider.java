package com.cxs.androidlib.rx;

import android.text.TextUtils;

import com.cxs.androidlib.CommonApplication;
import com.cxs.androidlib.utils.NetworkUtil;
...
public class OkHttpProvider {
    ...
    private static OkHttpClient getOkHttpClient(Interceptor cacheControl) {
        ...
        //设置缓存
        File httpCacheDirectory = new File(CommonApplication.getInstance().getCacheDir(), "OkHttpCache");

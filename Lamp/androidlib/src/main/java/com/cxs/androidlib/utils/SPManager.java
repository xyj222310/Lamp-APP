...
package com.cxs.androidlib.utils;
...
public class SPManager {
     ...
     * Preference文件名
     */
    private static final String SHARE_PREFREENCE_NAME = "itourapp.pre";
    ...
    private SPManager() {
        sp = CommonApplication.getInstance().getSharedPreferences(SHARE_PREFREENCE_NAME, Context.MODE_PRIVATE);
        editor = sp.edit();
    }

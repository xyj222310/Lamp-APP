...
/**
 * Created by _CXS on 16/8/4 21:18
 * 100332338@qq.com
 * <p/>
 * 自定义Banner无限轮播控件
 */
    ...
    public void build(List<BannerEntity> list)
    {
        ...
        for (int i = 0; i < bannerList.size(); i++)
        {
            ...
            Glide.with(getContext())
                    ...
                    .dontAnimate()
                    .into(mImageView);
//            ImageLoader.displayImage(mImageView,bannerList.get(i).img);
    ...
    {
        WebViewActivity.start((Activity)getContext(),
